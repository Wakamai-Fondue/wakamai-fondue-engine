export default {
	...
	Bangla:
		"়৺অআইঈউঊঋৠঌৡএঐওঔংঃঁক\\u09CDষখগঘঙচছজঝঞটঠডBঢণতৎথদধনপফবভমযরলশসহঽািীুূৃৄৢৣেৈোৌ্ৗU-,;:!?.()[]{}",
	Bosnian:
	...
	Welsh:
		"aáàâäbchdeéèêëfgniíìîïjlmoóòôöprstuúùûüwẃẁŵẅyýỳŷÿAÁÀÂÄBCHDEÉÈÊËFGNIÍÌÎÏJLMOÓÒÔÖPRSTUÚÙÛÜWẂẀŴẄYÝỲŶŸ-‐–—,;:!?.…'‘’\\\"“”()[]§@*/&#†‡′″",
	Danish:
		"abcdefghijklmnopqrstuvwxyzæøåABCDEFGHIJKLMNOPQRSTUVWXYZÆØÅ-‐–,;:!?.…'‘’\\\"“”()[]§@*/&#†′″",
	German:
		"aäbcdefghijklmnoöpqrsßtuüvwxyzAÄBCDEFGHIJKLMNOÖPQRSSSTUÜVWXYZ-‐–—,;:!?.…'‘‚\\\"“„«»()[]{}§@*/&#",
	Greek:
		'αάβγδεέζηήθιίϊΐκλμνξοόπρσςτυύϋΰφχψωώΑΆΒΓΔΕΈΖΗΉΘΙΊΪΪ́ΚΛΜΝΞΟΌΠΡΣΤΥΎΫΫ́ΦΧΨΩΏ-‐–—,;:!.…\\"«»()[]§@*/\\\\&',
	English:
	...
	Basque:
		"abcçdefghijklmnñopqrstuvwxyzABCÇDEFGHIJKLMNÑOPQRSTUVWXYZ-‐–—,;:!?.…'‘’\\\"“”()[]§@*/&#†‡′″",
	Persian:
	...
	Hindi:
		"़ॐंँःअआइईउऊऋऌऍएऐऑओऔकखगघङचछजझञटठडढणतथदधनपफबभमयरलळवशषसहऽािीुूृॄॅेैॉोौ्-,;:!?.‘’“”()[]{}॰",
	Croatian:
		"abcčćdžđefghijklmnoprsštuvzABCČĆDŽĐEFGHIJKLMNOPRSŠTUVZ‐–—,;:!?.…'‘’‚\\\"“”„()[]@*/′″",
	Hungarian:
	...
	Khmer:
		'័ៈ់៉៊៍កខគឃងចឆជឈញដឋឌឍណតថទធនបផពភមយរឫឬលឭឮវសហឡអាឥឦឧឩឪឯឰឱឲឳិីឹឺុូួើឿៀេែៃោៅំះ្-,៖!?.។៕‘’\\"“”()[]{}៙៚',
	Kannada:
	...
	Kyrgyz:
		"абгдеёжзийклмнӊоөпрстуүхчшъыэюяАБГДЕЁЖЗИЙКЛМНӉОӨПРСТУҮХЧШЪЫЭЮЯ-‐–—,;:!?.…'‘‚\\\"“„«»()[]{}§@*/&#",
	...
	Malay:
		"aiubcdzefghjklmnyopqrstvwxAIUBCDZEFGHJKLMNYOPQRSTVWX-‐–—,;:!?.…'‘’\\\"“”()[]§@*/&#†‡′″",
	Burmese:
	...
	Nepali:
		"़ँंःॐअआइईउऊऋऌऍएऐऑओऔकखगघङचछजझञटठडढणतथदधनपफबभमयरलळवशषसहऽािीुूृॄॅेैॉोौ्-,;:!?.()[]{}",
	Dutch:
		"aáäbcdeéëfghiíïj\\u031klmnoóöpqrstúüvwxyzAÁÄBCDEÉËFGHIÍÏJUKLMNOÓÖPQRSTÚÜVWXYZ-‐–—,;:!?.…'‘’\"“”()[]§@*/&#†‡′″",
	Punjabi:
	...
	Slovak:
		"aáäbcčdďeéfghiíjklĺľmnňoóôpqrŕsštťuúvwxyýzžAÁÄBCČDĎEÉFGHIÍJKLĹĽMNŇOÓÔPQRŔSŠTŤUÚVWXYÝZŽ-‐–,;:!?.…‘‚“„()[]§@*/&",
	Slovenian:
	...
	Telugu:
		"అఆఇఈఉఊఋౠఌౡఎఏఐఒఓఔఁంఃకఖగఘఙచఛజఝఞటఠడఢణతథదధనపఫబభమయరఱలవశషసహళాిీుూృౄెేైొోౌ్ౕౖ-,;:!?.'‘’\\\"“”()[]{}",
	Thai:
		"ฯๆ๎์็่้๊๋กขฃคฅฆงจฉชซฌญฎฏฐฑฒณดตถทธนบปผฝพฟภมยรฤลฦวศษสหฬอฮํะัาๅำิีึืุูเแโใไฺ!\\\"#'()*,-./:@[]‐–—‘’“”…′″",
	Tongan:
		"aáāeéēfhiíīklmngoóōpstuúūvʻAÁĀEÉĒFHIÍĪKLMNGOÓŌPSTUÚŪV-‐–—,;:!?.…'‘’\\\"“”()[]§@*/&#†‡′″",
	Turkish:
	...
	Uzbek:
		"abdefghijklmnopqrstuvxyzʻcʼABDEFGHIJKLMNOPQRSTUVXYZC-‐–—,;:!?.…'‘’\\\"“”„«»()[]{}§@*/&#′″",
	Vietnamese:
